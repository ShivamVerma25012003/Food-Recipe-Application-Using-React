...
const App = () => {
  const APP_ID = "28761e26";
  const APP_KEY = "9948a601c780399dfdd5656f200198f1";
  ...
  return (
    <div>
      <form class="text-red-500 bg-red-500 body-font" onSubmit={getSearch}>
        <div class="container py-10 mx-auto">
          ...
          <div class="flex lg:w-1/2 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0 items-end sm:space-x-4 sm:space-y-0 space-y-4">
            <div class="relative sm:mb-0 flex-grow w-full">
              <label for="full-name" class="leading-7 text-sm text-gray-500"><b>Search Recipe</b></label>
      ...
      <div class="fixed bottom-0 w-full bg-red-800 text-white p-4 text-center">
    <p class="text-sm">Developed by Shivam Verma | All rights reserved ©2023 |</p>
  </div>
